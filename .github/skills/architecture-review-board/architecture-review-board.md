# Architecture Review Board Mentor Skill
...
- Add whole conversation transcript to a new file called [challenge-name]-review-transcript.md in the solutions/review-board folder.
